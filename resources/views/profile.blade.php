                    ...
                    <div class="twocol" style="height: 332px; margin-top:40px; margin-bottom: 40px;">
                        ...
                        <div class="form__control--double">
                            <div class="form__control form__control--small">
                                ...
                                <input type="text" id="street" name="street" placeholder="{{ $user->street }}" value="{{ $user->street }}">    
                            </div>
                            <div class="form__control form__control--smaller">
                                <label for="housenumber">housenumber</label>
                                <input type="text" id="housenumber" name="housenumber" placeholder="{{ $user->housenumber }}" value="{{ $user->housenumber }}">    
                            </div>
                        </div>
                        <div class="form__control--double">
                            <div class="form__control form__control--small">
                                <label for="city">city</label>
                                <input type="text" id="city" name="city" placeholder="{{ $user->city }}" value="{{ $user->city }}">    
                            </div>
                            <div class="form__control form__control--smaller">
                                <label for="postal">postal</label>
                                <input type="text" id="postal" name="postal" placeholder="{{ $user->postal }}" value="{{ $user->postal }}">    
                            </div>
                        </div>
                        <div class="form__control">
                            <label for="country">country</label>
                            <input type="text" id="country" name="country" placeholder="{{ $user->country }}" value="{{ $user->country }}">    
                        </div>
                        <div class="form__control">
