...
class CollectionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $c1->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1635443809/thumbs_b_c_5ef25e9fbb465b177012cd9490d43d5a_f3s4ix.jpg';
        $c1->creator_id = 4;
        $c1->save();
        ...
        $c2->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1635443809/thumbs_b_c_5ef25e9fbb465b177012cd9490d43d5a_f3s4ix.jpg';
        $c2->creator_id = 3;
        $c2->save();
        ...
        $c3->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1635443809/thumbs_b_c_5ef25e9fbb465b177012cd9490d43d5a_f3s4ix.jpg';
        $c3->creator_id = 4;
        $c3->save();
        ...
        $c4->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1635443809/thumbs_b_c_5ef25e9fbb465b177012cd9490d43d5a_f3s4ix.jpg';
        $c4->creator_id = 4;
        $c4->save();
        ...
        $c5->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1635443809/thumbs_b_c_5ef25e9fbb465b177012cd9490d43d5a_f3s4ix.jpg';
        $c5->creator_id = 4;
        $c5->save();
