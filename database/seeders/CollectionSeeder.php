...
class CollectionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $c1->image_file_path = 'https://ipfs.io/ipfs/QmYTBiHNeEbAryjqDVvyBQ6u5BJPpBmF69jMhNtKmKm81H';
        $c1->creator_id = 4;
        $c1->save();
        ...
        $c2->image_file_path = 'https://ipfs.io/ipfs/QmYTBiHNeEbAryjqDVvyBQ6u5BJPpBmF69jMhNtKmKm81H';
        $c2->creator_id = 3;
        $c2->save();
        ...
        $c3->image_file_path = 'https://ipfs.io/ipfs/QmYTBiHNeEbAryjqDVvyBQ6u5BJPpBmF69jMhNtKmKm81H';
        $c3->creator_id = 4;
        $c3->save();
        ...
        $c4->image_file_path = 'https://ipfs.io/ipfs/QmYTBiHNeEbAryjqDVvyBQ6u5BJPpBmF69jMhNtKmKm81H';
        $c4->creator_id = 4;
        $c4->save();
        ...
        $c5->image_file_path = 'https://ipfs.io/ipfs/QmYTBiHNeEbAryjqDVvyBQ6u5BJPpBmF69jMhNtKmKm81H';
        $c5->creator_id = 4;
        $c5->save();
