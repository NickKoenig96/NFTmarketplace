...
class CollectionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $c1->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1634481475/default_odqauf.png';
        $c1->creator_id = 4;
        $c1->save();
        ...
        $c2->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1634481475/default_odqauf.png';
        $c2->creator_id = 3;
        $c2->save();
        ...
        $c3->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1634481475/default_odqauf.png';
        $c3->creator_id = 4;
        $c3->save();
        ...
        $c4->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1634481475/default_odqauf.png';
        $c4->creator_id = 4;
        $c4->save();
        ...
        $c5->image_file_path = 'https://res.cloudinary.com/dqelbnq5n/image/upload/v1634481475/default_odqauf.png';
        $c5->creator_id = 4;
        $c5->save();
